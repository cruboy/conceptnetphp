...
<div style="width:<? echo strlen($value['text'])*8;?>px;">○<span onclick="dotovv(<?php echo $value['id']; ?>)" title="<?php echo $value['f3']; ?>个<?php echo $value['num_assertions']; 
?>链<?php echo $value['frame']; ?>" style="font-family:<?=$fts[rand(0,36)]?>;"><?php echo $value['text']; ?></span>
<?php if($value['aurl'] !='' ): ?>
