...
<script type="text/javascript" src="./include/lib/js/common.js"></script>
<head>
...
<div id="navi">
<a href="./" id="active"><?php echo $username;?></a> 
<?php echo $usersina_name; ?> ，您好！
<a href="./" >首页</a> 
<a href="./?action=list">平台</a> 
<a href="./?action=tw">导入</a> 
<a href="./?action=com">评论</a> 
<a href="./?action=me">资料</a> 
<a href="./?action=edit" id="active">编辑资料</a> 
<a href="./?action=about">说明</a>
