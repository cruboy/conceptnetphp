...
<span onclick='ch(<?php echo $value['id']; ?>,this)' 
 style="<? if(!$value['visible']) echo 'text-decoration:line-through;'; ?>font-size:<? if($value['f3']>500)echo '24';elseif($value['f3']>100)echo '22';elseif($value['f3']>50)echo '20';elseif($value['f3']>10)echo '18';else echo "16";?>px" title="<?php echo $value['f3']; ?>">
